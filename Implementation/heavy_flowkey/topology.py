"""
table_add mac_to_port forward 00:00:00:00:00:01 => 1
table_add mac_to_port forward 00:00:00:00:00:02 => 2
table_add mac_to_port forward 00:00:00:00:00:03 => 3
...
class P4Switch(Switch):
    def start(self, controllers):
        ...
        self.cmd('simple_switch --log-console -i 1@s1-eth1 -i 2@s1-eth2 -i 3@s1-eth3 heavy.json >> logs.txt &')
